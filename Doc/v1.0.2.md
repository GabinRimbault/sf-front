...
## SCSS
### Utils
- **_variables**: Ajouts de plusieurs variables font-size et font-weight.

### Base
- **_tag**: La class dispose maintenant d'une proprieter `rounded`.

### Global
- Addition of the **_font** file (refer to the file for more details)

### Modules/General
- Modification de **_alert** pour convenir avec la modification react.
